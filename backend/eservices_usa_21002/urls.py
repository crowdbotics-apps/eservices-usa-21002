"""eservices_usa_21002 URL Configuration
...
admin.site.site_header = "eServices USA"
admin.site.site_title = "eServices USA Admin Portal"
admin.site.index_title = "eServices USA Admin"

# swagger
api_info = openapi.Info(
    title="eServices USA API",
    default_version="v1",
    description="API documentation for eServices USA App",
)
